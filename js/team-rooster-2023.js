const load2023TeamRooster = function(){
  const students = [
    ...
    new Student("Ana", "Anita.JPG", [TeamAreas.FINANZAS, TeamAreas.INGENIERIA, TeamAreas.SOCIALES]),
    new Student("Hiroki", "Hiroki.JPG", [TeamAreas.COMUNICACION, TeamAreas.INGENIERIA, TeamAreas.SOCIALES], "Hiro"),
    new Student("Damián", "Damián.JPG", [TeamAreas.COMUNICACION, TeamAreas.FINANZAS, TeamAreas.SOCIALES]),
    ...
    new Student("Clara", "Clara.JPG", [TeamAreas.COMUNICACION, TeamAreas.SOCIALES, TeamAreas.INCLUSION]),
    ...
    new Student("Juan Pablo", "JP.JPG", [TeamAreas.COMUNICACION, TeamAreas.INGENIERIA], "J P"),
    ...
    new Student("Paola", "Paola_Gil.JPG", [TeamAreas.COMUNICACION, TeamAreas.FINANZAS, TeamAreas.SOCIALES]),
    ...
    new Student("Sara", "Sarita.JPG", [TeamAreas.FINANZAS, TeamAreas.SOCIALES, TeamAreas.INCLUSION]),
    new Student("Agustín", "Agustín.JPG", [TeamAreas.INGENIERIA], "Agus"),
    new Student("Victoria", "Victoria.JPG", [TeamAreas.INGENIERIA, TeamAreas.SOCIALES], "Victoria"),
  ...
  const mentors = [
    ...
    new Mentor("Ulises", "Uri.JPG", [TeamAreas.FINANZAS, TeamAreas.INGENIERIA, TeamAreas.SOCIALES]),
    ...
    new Mentor("Alexis", "Alexis.JPG", [TeamAreas.FINANZAS, TeamAreas.INGENIERIA], "Alexis"),
